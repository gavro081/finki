...
class DirectedAdjacencyListGraph<T> {
...
public class Doma10_2 {
    public static void main(String []args){
        Scanner in = new Scanner(System.in);
        HashMap<String, String> ingredients = new HashMap<>();
        DirectedAdjacencyListGraph<String> graph = new DirectedAdjacencyListGraph<>();
        int n = in.nextInt();
        in.nextLine();
        for (int i = 0; i < n; i++) {
            ...
            ingredients.put(parts[0], parts[1]);
        }
        int m = in.nextInt();
        in.nextLine();
        int ans = 0;
        ...
        for (Map.Entry<String, String> ingredient : ingredients.entrySet() ){
            Map<String, Integer> shortest = graph.shortestPath(ingredient.getKey());
            ans += shortest.get(ingredient.getValue());
        }
